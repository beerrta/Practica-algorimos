...
while l<length(poblacio)/2
    ...
    for m=4:portes
        for n=1:portes
            if m>n
               random=rand(1);
               if random>0.5% tenim un 50% de probs de que la desendencia tingui part del pare o de la mare 
                   A(n,m)=B(n,m);
               end
            end
        end
